...
#РУКОВОДСТВО
# Лайк - открытие картинки
# Знак V - Hello world на экран
# Знак Ok - дата, время на экран
# Средний палец - запуск доты
# Раскрытая ладноь (надо удерживать) - закрытие
# Знак ILY - начать играть музыку
# Кулак - остановить музыку
# ВАЖНО!!! Программа очень любит путать лайк и кулак, поэтому надо помнить что кулак это когда большой палец прижат к середине, а лайк может быть обнаружен если большой палец не на середине, а просто согнут :(   (пытаюсь пофиксить)
